    ...
    return (
        <div className="form-wrapper">
            ...
            >
                ...
                {errors.question && (
                    <p style={{ color: "#ae0000" }}>Invalid input</p>
                )}
            ...
            {warn && (
                <Modal>
                    <h2>Are you sure?</h2>
                    <h3>
                        Generating a new question and answer will delete the
                        current information stored in this faq.
                    </h3>
